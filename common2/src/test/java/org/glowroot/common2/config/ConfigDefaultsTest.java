...
public class ConfigDefaultsTest {
    ...
    public void shouldGetLastPart() {
        ...
        assertThat(MoreConfigDefaults.getLastPartForDisplay("aaa::")).isEqualTo("aaa");
        assertThat(MoreConfigDefaults.getLastPartForDisplay("aaa::bbb")).isEqualTo("bbb");
        assertThat(MoreConfigDefaults.getLastPartForDisplay("aaa::bbb::")).isEqualTo("bbb");
        assertThat(MoreConfigDefaults.getLastPartForDisplay("aaa::bbb::ccc")).isEqualTo("ccc");
        assertThat(MoreConfigDefaults.getLastPartForDisplay("aaa::bbb::ccc::")).isEqualTo("ccc");
    }
}
